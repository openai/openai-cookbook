...
- [Flow-Prompt](https://github.com/LamoomAI/flow-prompt): A Python library for fitting dynamic data based on priorities. Real-time updating and intelligent automatic budgeting. Automatic retries of repeatable errors, such as rate-limit errors.
