...
```bash
uv run examples/agents_api/sandboxes/blaxel/webhook_managed/deploy.py
```
...
```bash
uv run examples/agents_api/sandboxes/blaxel/webhook_managed/client.py --agent-id "$OPENAI_AGENT_ID"
```
