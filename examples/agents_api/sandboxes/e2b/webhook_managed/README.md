...
```bash
uv run examples/agents_api/sandboxes/e2b/webhook_managed/deploy.py
```
...
```bash
uv run examples/agents_api/sandboxes/e2b/webhook_managed/client.py --agent-id "$OPENAI_AGENT_ID"
```
