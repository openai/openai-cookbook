...
def resolve_audio_path(audio_path_value: str, dataset_path: Path) -> Path:
    ...
    # Validate that the audio path is a safe relative path within the dataset directory
    return validate_safe_relative_path(audio_path_value, dataset_path.parent, "audio_path")
...
def build_failed_result(
    ...
    if audio_path_value:
        audio_path = validate_safe_relative_path(audio_path_value, dataset_path.parent, "audio_path")
    else:
