...
- Pull requests run credential-free Python, MCP adapter, and Promptfoo checks
  through `.github/workflows/ci.yml`. Those checks deliberately make no live
  AWS, OpenAI, or tunnel calls.
