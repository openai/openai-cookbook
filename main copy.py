...
class CodeToolbox:
    ...
    def get_modified_code_files() -> dict:
        ...
        allowed_extensions = [".py", ".cpp", ".java",
                              ".js", ".scala", ".sas", ".json", ".csv"]
        ...
        for file in code_files:
            ...
            try:
                ...
                print(
                    f"Skipping invalid line: {file}. Most likely it is due to renaming the file.")
    ...
    def documenter(self, func_str):
        ...
        command = ['autoflake', '--in-place',
                   '--remove-all-unused-imports', self.file_path]
    ...
    def unit_tester(self, class_name='', func_str='', function_name=''):
        ...
        request_for_unit_test = f" provide unit test for the function `{self.class_part}`.\
            ...
            "
        self.unit_test_messages.append(
            {"role": "user", "content": request_for_unit_test})
