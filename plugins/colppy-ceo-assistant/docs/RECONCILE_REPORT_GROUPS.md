...
**WRONG_STAGE:** Colppy activa = 0 (company active), HubSpot deal exists but not closed-won (e.g. Cerrado Churn). Requires `deals_any_stage` populated via `--fetch-wrong-stage`.
