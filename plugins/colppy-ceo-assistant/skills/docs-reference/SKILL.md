...
# Documentation Reference — Colppy CEO Assistant

**Rule:** For any Colppy-specific question (HubSpot, MRR, churn, Mixpanel, ICP, funnel, billing, pagination, deal stages), **read the relevant doc from `docs/` first**. The docs are the source of truth — do not rely on general knowledge.
...
| Intercom integration | `docs/README_INTERCOM_CONSOLIDATED.md` |
...
| Colppy first payments vs HubSpot reconciliation (4-group) | `docs/COLPPY_HUBSPOT_RECONCILIATION.md`, `docs/RECONCILE_REPORT_GROUPS.md`, `docs/colppy_hubspot_reconciliation_snapshot.json` |
...
- COLPPY_HUBSPOT_RECONCILIATION.md
- RECONCILE_REPORT_GROUPS.md
- colppy_first_payments_snapshot.json
...
- README_INTERCOM_CONSOLIDATED.md
