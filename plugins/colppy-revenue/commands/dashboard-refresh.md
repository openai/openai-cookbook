...
```
/colppy-revenue:dashboard-refresh
/colppy-revenue:dashboard-refresh full
/colppy-revenue:dashboard-refresh building-blocks
/colppy-revenue:dashboard-refresh dashboard-only
```
