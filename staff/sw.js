const CACHE='aumara-staff-pwa-v2.1.1';
const SHELL=['/staff/','/staff/index.html','/staff/styles.css?v=210','/staff/app.js?v=210','/staff/patch.js?v=211','/staff/manifest.webmanifest','/staff/icon.svg'];
