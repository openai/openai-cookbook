...
echo "Building Blocks budget dashboard..."
python tools/scripts/refresh_budget_dashboard.py --output "$OUTPUT_DIR/budget_dashboard.html"

echo ""
echo "Done. Dashboards written to $OUTPUT_DIR/mrr_dashboard.html, $OUTPUT_DIR/icp_dashboard.html, $OUTPUT_DIR/budget_dashboard.html"
echo ""
