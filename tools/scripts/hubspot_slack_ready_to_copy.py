#!/usr/bin/env python3
"""
HubSpot Custom Code with Slack Notifications - READY TO COPY/PASTE
================================================================

This is the complete custom code ready to copy/paste into HubSpot with your Slack webhook URL.

Author: CEO Assistant
Date: September 13, 2025
"""

# Complete JavaScript Custom Code for HubSpot - READY TO COPY/PASTE
HUBSPOT_CUSTOM_CODE_WITH_SLACK = '''
...
// Slack notification function with your webhook URL
...
def main():
    """Display the ready-to-copy custom code."""
    print("🚀 HUBSPOT CUSTOM CODE WITH SLACK NOTIFICATIONS - READY TO COPY/PASTE")
    print("=" * 80)
    print()
    print("✅ YOUR SLACK WEBHOOK URL IS ALREADY INCLUDED!")
    print("✅ ALL FUNCTIONALITY PRESERVED!")
    print("✅ SLACK NOTIFICATIONS ENABLED!")
    print()
    print("📋 WHAT THIS CODE DOES:")
    print("   🔄 Calculates first_deal_closed_won_date (existing functionality)")
    print("   🚨 Sends Slack warning when no primary deals found")
    print("   ℹ️  Sends Slack info when no won deals found")
    print("   ✅ Sends Slack success when field is updated")
    print("   ❌ Sends Slack error when workflow fails")
    print()
    print("🎯 TESTING INSTRUCTIONS:")
    print("   1. Copy the code below")
    print("   2. Paste it into your HubSpot workflow custom code")
    print("   3. Run the workflow on 'Gisela Mariotti Contadora'")
    print("   4. Check your Slack channel for the notification!")
    print()
    print("📝 CUSTOM CODE TO COPY/PASTE:")
    print("-" * 80)
    print(HUBSPOT_CUSTOM_CODE_WITH_SLACK)
    print("-" * 80)
    print()
    print("🎉 READY TO TEST! Let me know what happens!")
