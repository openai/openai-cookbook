...
def find_conversation_file(start_date, end_date):
    ...
    patterns = [
        ...
        f'outputs/csv_data/intercom/conversations/intercom_conversations_{file_suffix}.csv',
        f'intercom-conversations-{file_suffix}.csv',
        f'intercom_conversations_{file_suffix}.csv'
    ]
    ...
    # If no specific file found, return a generic pattern for user to specify
    return f'outputs/csv_data/intercom/conversations/intercom-conversations-{file_suffix}.csv'
