...
**For existing users of these endpoints, access will continue until December 2022.** Before that date, we strongly encourage developers to switch over to newer techniques which produce better results.
