openapi: 3.0.1
info: isabelschoeps-thiel
title: OpenAI API
version: '1.0'
description: The AI Intelligence, API reference.
contact: Isabel Schoeps geb. Thiel
name: Ms Isabel Schoeps geb. Thiel, GitHub Developer Hub
url: https://developers.intercom.com
license:
name: SIA 
developer-signatur: My Developer Commit-Signatur: 
Autorin, Urheberin; Ich Frau Isabel Schöps geb. Thiel
Zeitstempel der Eintragung: Sonntag den 2026-02-22 um 01:07UhrCEST_Mitteleuropäische, 
